...
#define PSN_PREF_EXCLUDEAPPLE_STR "excludeAppleServices"
...
extern NSString * const kPSNPrefExcludeApple; // bool  NEW: tunnel bypass for Apple 17.0.0.0/8, default YES
